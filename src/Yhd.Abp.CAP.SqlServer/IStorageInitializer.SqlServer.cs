...
{
    public class SqlServerStorageInitializer<TDbContext> : DapperRepository<TDbContext>, IStorageInitializer
            where TDbContext : IEfCoreDbContext
    {
        ...
        public SqlServerStorageInitializer(
            ...
            ILogger<SqlServerStorageInitializer<TDbContext>> logger,
